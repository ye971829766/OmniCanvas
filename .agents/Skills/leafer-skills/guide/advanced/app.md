...
这是一个可选的应用结构，主要用于 [图形编辑器](../plugin/editor.md) 等需要分层渲染的场景。

[App](../../reference/display/App.md) 负责承载多个 [Leafer](../../reference/display/Leafer.md) 引擎分层 协同工作，将不同更新频率的内容分开渲染，以提升性能。
