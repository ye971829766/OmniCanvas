...
```html [web.min]
<script src="https://unpkg.com/leafer@2.1.4/dist/web.min.js"></script>
<script>
...
```html [web]
<script src="https://unpkg.com/leafer@2.1.4/dist/web.js"></script>
<script>
  const { Leafer, Editor, Robot, Animate } = LeaferUI
  // ...
</script>
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer@2.1.4/dist/web.module.min.js'
  // ...
</script>
```
...
<script type="module">
  import {
    ...
    Editor,
    Arrow,
  } from 'https://unpkg.com/leafer@2.1.4/dist/web.module.js'
  // ...
</script>
```
