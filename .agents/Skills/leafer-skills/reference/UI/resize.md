...
若元素的 [lockRatio](./editable.md#lockratio-boolean) 为 true, 将同时等比例调整宽度。
...
### [setTransform ()](./transform.md#关键方法)

### [transform ()](./transform.md#关键方法)

### [scaleOf ()](./scale.md#关键方法)

### [skewOf ()](./skew.md#关键方法)

### [transformWorld ()](./transform.md#相对世界坐标系)

### [scaleOfWorld ()](./scale.md#关键方法)

### [skewOfWorld ()](./skew.md#关键方法)
