...
### 基础 &nbsp; &nbsp; [视口类型](./type.md) &nbsp; &nbsp; [画布](./canvas.md) &nbsp; &nbsp; [点按](./pointer.md) &nbsp; &nbsp; [多点](./multiTouch.md) &nbsp; &nbsp; [触屏](./touch.md) &nbsp; &nbsp; [滚轮](./wheel.md) &nbsp; &nbsp; [平移视图](./move.md) &nbsp; &nbsp; [缩放视图](./zoom.md)

##

[App](../../display/App.md) 与 [Leafer](../../display/Leafer.md) 的初始化基础配置。
...
启动后，可以通过 [app.stop()](../../display/Leafer.md#start)、 [app.start()](../../display/Leafer.md#start) 手动控制渲染。

## 渲染布局属性

引擎运行中修改 [leafer.config](../../display/Leafer.md#config-ileaferconfig) 立即生效。
...
想要图片不模糊，还可以继续配置 [config.smooth](./canvas.md#smooth-boolean) 属性。

引擎运行中修改 [leafer.confg / app.tree.config](../../display/Leafer.md#config-ileaferconfig) 立即生效。
