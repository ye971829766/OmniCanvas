...
另外可使用 [element](../index.md#element-ui) 元素的布局属性方法直接移动、变换编辑框。
...
围绕 [element](../index.md#element-ui) 元素的原点 origin（ [box 坐标](../../../../guide/advanced/coordinate.md#box-坐标系) ）缩放选中元素 <badge>增量操作</badge>。
...
围绕 [element](../index.md#element-ui) 元素的原点 origin（ [box 坐标](../../../../guide/advanced/coordinate.md#box-坐标系) ）旋转选中元素 <badge>增量操作</badge>。
...
围绕 [element](../index.md#element-ui) 元素的原点 origin（ [box 坐标](../../../../guide/advanced/coordinate.md#box-坐标系) ）倾斜选中元素 <badge>增量操作</badge>。
