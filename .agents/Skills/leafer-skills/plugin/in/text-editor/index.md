...
<script src="https://unpkg.com/@leafer-in/text-editor@2.1.4/dist/text-editor.min.js"></script>
<script>
...
```html [text-editor]
<script src="https://unpkg.com/@leafer-in/text-editor@2.1.4/dist/text-editor.js"></script>
<script>
  const { TextEditor } = LeaferIN.textEditor
</script>
```
