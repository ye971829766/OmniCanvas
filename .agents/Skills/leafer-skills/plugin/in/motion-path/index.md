...
<script src="https://unpkg.com/@leafer-in/motion-path@2.1.4/dist/motion-path.min.js"></script>
```

```html [motion-path]
<script src="https://unpkg.com/@leafer-in/motion-path@2.1.4/dist/motion-path.js"></script>
```
